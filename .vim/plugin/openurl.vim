...
"
" Modified by Porter Glines
"   - changed command to ':Ourl'
"   - changed regex to include https
"
" Summary
" =======
...
"
" You use ':OpenUrl' (modified to ':Ourl' command in this line, 
...
re_obj = re.compile(r'http[s]://[a-zA-Z0-9-./"#$%&\':?=_]+')
