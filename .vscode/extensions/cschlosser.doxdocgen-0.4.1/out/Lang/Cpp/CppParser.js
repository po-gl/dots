...
class CppParser {
    ...
    Parse(activeEdit) {
        ...
        return new CppDocGen_1.CppDocGen(this.activeEditor, this.activeSelection, this.cfg, templateArgs, args[0], args[1], this.specialCase, this.commentType, this.casingType);
    }
    /***************************************************************************
                                    Implementation
     ***************************************************************************/
